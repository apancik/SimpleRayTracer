 ...
 */
public class PerlinNoise1 implements IMaterial {
    ...
    public PerlinNoise1(double persistence, int octaves, double shininess, double reflectance) {
    ...
    public PerlinNoise1(double persistence, int octaves, double shininess, double reflectance, double diffuseReflectionConstant, double specularReflectionConstant, double ambientReflectionConstant) {
        this.persistence = persistence;
        this.octaves = octaves;
        this.shininess = shininess;
        this.reflectance = reflectance;
